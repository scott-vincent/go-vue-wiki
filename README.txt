...
Notes:
    During development you can use the 'refresh server' shortcut instead. This will monitor the backend
    folder for source file changes and will automatically build and run the server after any change.
    
    To install refresh.exe (written in go) use: go get github.com/markbates/refresh